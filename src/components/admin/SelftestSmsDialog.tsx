...
const TEMPLATES = [
  ...
  },
  {
    ...
    icon: Bell,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): สวัสดีคุณ {{name}} ทีมงานติดต่อเพื่อดูแลคุณต่อ หากต้องการคำปรึกษา โทร 02-632-9501 หรือนัดคลินิก: https://testd.website/booking",
    bodyEn: "SWING Foundation: Hi {{name}}, our team is reaching out to support you. For advice, call 02-632-9501 or book a clinic: https://testd.website/booking",
  },
  {
    key: "remind_report",
    category: "followup",
    ...
    icon: FileText,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): คุณ {{name}} ถึงเวลารายงานผลของคุณแล้ว เปิดลิงก์เพื่อบันทึก: https://testd.website/submit-result หากต้องการความช่วยเหลือ โทร 02-632-9501",
    bodyEn: "SWING Foundation: Hi {{name}}, it's time to report your result. Open: https://testd.website/submit-result or call 02-632-9501",
  },
  {
  ...
  },
  {
    ...
    icon: Stethoscope,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): คุณ {{name}} เชิญคุณเข้ารับบริการที่คลินิกฟรี นัดเวลาที่สะดวก: https://testd.website/booking โทร 02-632-9501",
    bodyEn: "SWING Foundation: Hi {{name}}, we invite you to a free clinic visit. Book: https://testd.website/booking or call 02-632-9501",
  },
  {
    key: "clinic_reminder",
    category: "clinic",
  ...
  },
  {
    ...
    icon: HelpCircle,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): คุณ {{name}} เราสังเกตว่าคุณยังไม่ได้มาตามนัด หากต้องการนัดใหม่ โทร 02-632-9501 หรือจองออนไลน์: https://testd.website/booking",
    bodyEn: "SWING Foundation: Hi {{name}}, we noticed you missed your appointment. To reschedule, call 02-632-9501 or book online: https://testd.website/booking",
  },
  {
  ...
  },
  {
    ...
    labelEn: "PrEP info",
    icon: Shield,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): คุณ {{name}} สนใจข้อมูล PrEP หรือการป้องกัน? นัดคลินิก: https://testd.website/booking หรือโทร 02-632-9501",
    bodyEn: "SWING Foundation: Hi {{name}}, interested in PrEP or prevention? Book a clinic visit: https://testd.website/booking or call 02-632-9501",
  },
  {
    ...
    icon: Shield,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): คุณ {{name}} ผลล่าสุดเป็นลบ ขอแนะนำให้รับยา PrEP เพื่อป้องกันต่อเนื่อง ฟรี! นัดคลินิก: https://testd.website/booking หรือโทร 02-632-9501",
    bodyEn: "SWING Foundation: Hi {{name}}, your recent result is negative. We recommend starting PrEP for ongoing protection — free! Book: https://testd.website/booking or call 02-632-9501",
  },
  {
    ...
    icon: Shield,
    bodyTh: "มูลนิธิเพื่อนพนักงานบริการ (SWING): คุณ {{name}} กรุณาติดต่อรับยา PrEP ที่คลินิก โทร 02-632-9501 หรือจองเวลา: https://testd.website/booking",
    bodyEn: "SWING Foundation: Hi {{name}}, please contact the clinic to pick up your PrEP. Call 02-632-9501 or book: https://testd.website/booking",
  },
  {
    key: "custom",
    category: "custom",
