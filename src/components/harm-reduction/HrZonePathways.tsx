...
export default function HrZonePathways({ onNavigate }: Props) {
  ...
  const pathways = [
    ...
    },
    {
      id: "check",
      icon: ClipboardCheck,
      titleTh: "ประเมินตัวเอง",
      titleEn: "Check yourself",
      descTh: "ตรวจความเสี่ยง สุขภาพจิต ใช้เวลาแค่ 3 นาที",
      descEn: "Risk & mental health self-check — only 3 min",
    ...
    },
    {
      ...
      titleEn: "Get support",
      descTh: "ปรึกษาผู้เชี่ยวชาญ ขอ callback หรือช่วยเหลือเร่งด่วน",
      descEn: "Counseling, callback, or urgent help",
