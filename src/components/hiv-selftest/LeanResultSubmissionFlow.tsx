...
const T = {
  th: {
    ...
    optNeg: { title: "1 ขีด", sub: "ไม่เกิดปฏิกิริยา" },
    optReact: { title: "2 ขีด", sub: "เกิดปฏิกิริยา — ต้องตรวจซ้ำที่คลินิก" },
    optInvalid: { title: "ไม่มีขีด หรืออ่านไม่ออก", sub: "อ่านผลไม่ได้ เกิดขึ้นได้" },
    legendTitle: "แต่ละขีดหมายความว่าอะไร?",
    legendIntro: "แถบตรวจมี 2 ตำแหน่ง: C = เส้นควบคุม (บอกว่าชุดตรวจใช้ได้) และ T = เส้นผล",
    legendOne: "1 ขีด (ขึ้นที่ C เท่านั้น) = ไม่เกิดปฏิกิริยา (Non-reactive) ชุดตรวจใช้งานได้ปกติ หากเสี่ยงภายใน 1–3 เดือน ควรตรวจซ้ำอีกครั้ง",
    legendTwo: "2 ขีด (ขึ้นทั้ง C และ T) = เกิดปฏิกิริยา (Reactive) ยังไม่ได้แปลว่าติดเชื้อ ต้องตรวจยืนยันที่คลินิก ฟรีและเป็นความลับ",
    ...
    negBody:
      "ผล 1 ขีด คือ ไม่เกิดปฏิกิริยา (Non-reactive) หากมีโอกาสเสี่ยงในช่วง 1–3 เดือนที่ผ่านมา แนะนำให้ตรวจซ้ำในอีก 3 เดือนข้างหน้า",
    earned: "ได้รับ",
    setReminder: "ตั้งเตือนตรวจครั้งหน้า (3 เดือน)",
    setReminderToast: "เราจะแวะมาเตือนใน 3 เดือน",
    done: "เสร็จแล้ว",
    reactTitle: "เราอยู่ตรงนี้กับคุณ",
    reactBody1: "ผล 2 ขีด คือ เกิดปฏิกิริยา (Reactive) จากชุดตรวจเบื้องต้น ยังไม่ได้แปลว่าติดเชื้อ HIV",
