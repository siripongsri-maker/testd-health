...
const items: MenuItem[] = [
  ...
  {
    img: selfcare1Img,
    labelTh: 'ดูแลตัวเอง รับถุงยาง รับชุดตรวจ',
    labelEn: 'Self-care',
    path: '/self-care',
  ...
  {
    img: selfcare2Img,
    labelTh: 'วิธีป้องกันที่ใช่สำหรับคุณ',
