  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          o('ถุงยางอนามัย (คละไซซ์ 49/52/54)', 'Condoms, mixed sizes 49/52/54'),
          o('เจลหล่อลื่น (สูตรน้ำ)', 'Water-based lubricant'),
          o('ถุงมือไนไทรล์ (กันแพ้ยาง)', 'Nitrile gloves, latex-free'),
          o('ไปป์แก้วส่วนตัว (1 คน 1 ไปป์)', 'Personal glass pipe, no sharing'),
          o('ซิลิโคนมาธ์พีชสำหรับไปป์', 'Silicone mouthpiece for pipes'),
          o('ลิปบาล์ม', 'Lip balm'),
          o('อุปกรณ์ฉีดสะอาด (หลอดอินซูลิน 1 มล., น้ำกลั่นปลอดเชื้อ, สำลีแอลกอฮอล์)', 'Clean injecting set: insulin syringes, sterile water, alcohol swabs'),
          o('ยางรัดแขน (Tourniquet)', 'Tourniquet'),
          o('หลอดป้อนยาไม่มีเข็ม 5 มล. (สำหรับกะยา)', 'Needleless oral syringe 5ml for dosing'),
          o('สติกเกอร์และปากกาสำหรับติดแก้ว', 'Stickers and marker for cup labelling'),
          o('สเปรย์น้ำเกลือจมูก', 'Saline nasal spray'),
          o('ทิชชู่นุ่มและทิชชู่เปียก', 'Soft and wet tissues'),
          o('เจลล้างมือแอลกอฮอล์', 'Alcohol hand sanitizer'),
          o('ชุดตรวจเอชไอวีด้วยตัวเอง', 'HIV self-test kit'),
          o('ผงเกลือแร่', 'Electrolyte powder'),
          o('หมากฝรั่ง', 'Chewing gum'),
