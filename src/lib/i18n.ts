...
const translations: Record<'th' | 'en', Record<string, string>> = {
  th: {
    ...
    'admin.blog': 'บทความ',
    'admin.seoArticles': 'บทความ SEO',
    'admin.seoHealth': 'SEO Health Check',
    'admin.jsonLdCheck': 'JSON-LD Check',
    'admin.linkProspects': 'Link Prospects',
    'admin.disavow': 'Spam Links & Disavow',
    'admin.backlinks': 'Backlink Monitor',
    'admin.surveys': 'แบบสำรวจ',
    'admin.operations': 'ระบบ',
    'admin.kitOrders': 'ชุดตรวจ',
    'admin.selftestResults': 'รายงานผลตรวจ',
    'admin.pickupResults': 'ผลตรวจผู้รับหน้างาน',
    ...
    'admin.chemsexCards': 'การ์ด Chemsex → บริการ',
    ...
    'admin.preServiceSurveys': 'แบบสำรวจก่อนรับบริการ',
    'admin.import': 'นำเข้า',
    ...
    'admin.safetyPlanner': 'ตัวจัดการแผนความปลอดภัย',
    ...
    'admin.languageAnalytics': 'สถิติตามภาษา',
    ...
    'admin.dailyOps': 'ศูนย์งานรายวัน (ให้คำปรึกษา)',
    'admin.counselorSupport': 'คิวให้คำปรึกษา',
    'admin.dailyBranchBrief': 'สรุปรายวันรายสาขา',
    'admin.concernBrief': 'สรุปเรื่องที่กังวลรายวัน',
    ...
    'admin.melOutreach': 'กิจกรรมเชิงรุก',
    'admin.melTraining': 'การฝึกอบรม',
    'admin.melSafeSpaces': 'พื้นที่ปลอดภัย',
    'admin.melPartners': 'องค์กรพันธมิตร',
    'admin.melPolicy': 'นโยบายและความร่วมมือ',
    'admin.melEvaluation': 'การประเมินผล',
    'admin.melReporting': 'รายงาน MEL',
  ...
  en: {
    ...
    'auth.login': 'Sign in',
    'auth.signup': 'Sign up',
    'auth.loginSubtitle': 'Welcome back. Sign in to keep your progress in sync.',
    'auth.signupSubtitle': 'Create an account to save your progress and settings.',
    'auth.email': 'Email',
    ...
    'auth.invalidEmail': 'That email looks invalid.',
    'auth.passwordTooShort': 'Password needs to be at least 6 characters.',
    'auth.invalidCredentials': 'Email or password is incorrect.',
    'auth.userExists': 'This email is already in use.',
    'auth.loginSuccess': 'Welcome back!',
    'auth.signupSuccess': "You're in. Welcome to testD!",
    'auth.privacyNote': 'Your data is encrypted and kept private.',
    ...
    'admin.linkProspects': 'ลิงก์เป้าหมาย',
    'admin.disavow': 'ลิงก์สแปม / Disavow',
    'admin.backlinks': 'ติดตามลิงก์ย้อนกลับ',
    'admin.surveys': 'Surveys',
    'admin.operations': 'Operations',
    'admin.kitOrders': 'Kit Orders',
    'admin.selftestResults': 'Self-test Results',
    'admin.pickupResults': 'On-site Pickup Results',
    ...
    'admin.attribution': 'Attribution',
    'admin.chemsexCards': 'Chemsex Cards → Services',
    'admin.conversionInsights': 'Conversion Insights',
    'admin.hrReport': 'HR Report',
    'admin.feedbackOutcomes': 'Feedback & Outcomes',
    'admin.preServiceSurveys': 'Pre-Service Surveys',
    'admin.import': 'Import',
    'admin.abuseLogs': 'Anti-spam',
    ...
    'admin.safetyPlanner': 'Safety Planner',
    ...
    'admin.languageAnalytics': 'Language analytics',
    ...
    'admin.dailyOps': 'Daily Ops — Counseling',
    'admin.dailyBranchBrief': 'Daily Branch Brief',
    'admin.concernBrief': 'Daily Concern Brief',
    'admin.counselingPayouts': 'Travel Allowance Payouts',
    ...
    'admin.melOutreach': 'Outreach Events',
    'admin.melTraining': 'Training',
    'admin.melSafeSpaces': 'Safe Spaces',
    'admin.melPartners': 'Partner Orgs',
    'admin.melPolicy': 'Policy & Engagement',
    'admin.melEvaluation': 'Evaluation',
